...
<body>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="select_products.php">Select products</a></li>
                                    <li><a href="product_register.php">Add new</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-table"></i><span>CATEGORIES
                                    </span></a>
                                <ul class="collapse">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">HALLO</h4>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <form role="form" method="POST" enctype="multipart/form-data">
                                <?php 
                                    ...
                                    $update_product = $tbl_product->select_product($_GET["id"])->fetch_assoc();
                                ?>
                                        <div class="form-group">
                                            <label>Product Name</label>
                                            <input class="form-control" type="text" name="txt_product_name" value="<?php echo $update_product["product_name"] ?>">
                                            <p class="help-block">Input name here.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Number Product</label>
                                            <input class="form-control" type="number" name="txt_quantity" value="<?php echo $update_product["quantity"] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="txt_categories">
                                                <?php 
                                                    $tbl_category = new tbl_category();
                                                    $categories = $tbl_category->select_all();

                                                    echo "<option value='" . $update_product["category"] . "'>" . $update_product["category"] . "</option>";
                                                    echo "<option> - - - - - </option>";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="txt_date" value="<?php echo $update_product["date"] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Product Price</label>
                                            <input class="form-control" type="number" name="txt_price" value="<?php echo $update_product["price"] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Product Description</label>
                                            <textarea class="form-control" rows="3" name="txt_description"> <?php echo $update_product["description"] ?> </textarea>
                                        </div>    
                                        <br>
  ...
  if(isset($_POST["btn_submit"])) {
      ...
      if($tbl_product->update(
          ...
          $_POST["txt_quantity"],
          $file_name,
          $_POST["txt_categories"],
          $_POST["txt_date"],
          $_POST["txt_price"],
          $_POST["txt_description"]
      )) {
          echo "<script> alert('Sửa sản phẩm thành công'); window.location = 'select_products.php' </script>";
      }
  }
?>
                            </div>    
