                        ...
                        <?php 
                            ...
                            <form role="form" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="txt_category_name" value = "<?php echo $category["category_name"] ?>">
                                            <p class="help-block">Input name here.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Category Description</label>
                                            <textarea class="form-control" rows="3" name="txt_category_description"><?php echo $category["category_description"] ?></textarea>
                                    ...
                                    <?php
                                        if(isset($_POST["btn_submit"])) {
                                            if($tbl_category->update($_GET["id"], $_POST["txt_category_name"], $_POST["txt_category_description"])) {
